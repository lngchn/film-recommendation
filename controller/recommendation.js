...
function callPyScript(data, res) {
  ...
  var recs = []; 
  //Uncomment to store in the server side recommendation array.
  //var recs = user.recommendation;
  ...
  py.stdout.on('end', function(){  
    recs.push(JSON.parse(JSON.stringify(dataString)));
    res.json({message: recs}); 
  });
